...
// Source: application/contract/product.go
...
import (
	...
	contract "github.com/vmlellis/go-hexagonal/application/contract"
)
...
func (m *MockProductServiceInterface) Create(name string, price float64) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, price)
	ret0, _ := ret[0].(contract.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(Product contract.ProductInterface) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(Product contract.ProductInterface) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Get(id string) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductReader) Get(id string) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(contract.ProductInterface)
	ret1, _ := ret[1].(error)
...
func (m *MockProductWriter) Save(Product contract.ProductInterface) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductPersistenceInterface) Get(id string) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(contract.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(Product contract.ProductInterface) (contract.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", Product)
	ret0, _ := ret[0].(contract.ProductInterface)
	ret1, _ := ret[1].(error)
